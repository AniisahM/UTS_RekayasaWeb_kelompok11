  ...
  <body class="<?php echo $this['config']->get('body_classes'); ?>">
    <div class="body-innerwrapper">
            ...
            <nav class="tm-navbar-container">
              <?php if ($this['widgets']->count('logo')) : ?>
                <div class="tm-nav-logo uk-hidden-small">
                  <a class="tm-logo uk-responsive-width uk-responsive-height" href="<?php echo $this['config']->get('site_url'); ?>"><?php echo $this['widgets']->render('logo'); ?></a>
                </div>
              <?php endif; ?>
      ...
      <?php if ($this['widgets']->count('slideshow')) : ?>
        <div id="tm-slideshow" class="tm-block-slideshow uk-block uk-block-default tm-block-fullwidth">
      ...
      <?php endif; ?>
      <?php if ($this['widgets']->count('above-footer')) : ?>
        <div id="tm-above-footer" class="tm-block-above-footer uk-block">

          <div class="uk-container uk-container-center">

            <section class="<?php echo $classes['grid.above-footer']; ?>" data-uk-grid-match="{target:'> div > .uk-panel'}" data-uk-grid-margin>
              <?php echo $this['widgets']->render('above-footer', array('layout'=>$this['config']->get('grid.above-footer.layout'))); ?>
            </section>
