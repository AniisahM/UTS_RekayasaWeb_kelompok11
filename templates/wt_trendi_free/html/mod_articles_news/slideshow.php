...
?>
<div uk-slideshow="min-height: 350; max-height: 450;autoplay: true;" class="tm-module-slideshow uk-slideshow<?php if ($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
