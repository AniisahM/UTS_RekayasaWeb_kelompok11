...
?>
<div class="tm-trendi-recent uk-margin uk-child-width-1-1 uk-child-width-1-2@s uk-grid-match<?php if ($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>" uk-grid>
